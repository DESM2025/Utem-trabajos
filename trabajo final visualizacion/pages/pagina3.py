    ...
    if st.session_state.show_graphs:
        ...
        with col1:
            ...
            fig_scatter = px.scatter(
                ...
                title="Puntaje vs Numero de Comentarios",
            ...
            fig_hist = px.histogram(
                ...
                title="Distribucion del Engagement Rate por Tipo de Post",
        ...
        with col2:
            ...
            if len(df_filtrado) > 0: 
                ...
                fig_bar = px.bar(
                    ...
                    orientation='h', 
                    title="Top 10 Posts con Mayor Puntaje",
            ...
            fig_box = px.box(
                ...
                y='puntaje',
                color='dia_semana', 
                title="Distribucion de Puntajes por dias de la semana",
        ...
        variables_numericas = ['puntaje', 'numero_comentarios', 'upvotes', 'downvotes', 
                                'longitud_titulo', 'longitud_texto', 'engagement_rate', 'hora'] 
        ...
        if len(vars_con_datos) >= 2:
            ...
            fig_heatmap = px.imshow(
                ...
                # usar paleta de colores cerezo
                color_continuous_scale=SAKURA_CONTINUOUS_PALETTE,
                title="Matriz de Correlación entre Variables de Posts",
