    ...
    if st.session_state.show_charts_manga:
        ...
        with col1:
            ...
            fig_scatter = px.scatter(
                ...
                title="Scatter Plot de puntuacion vs cantidad de miembros individual",
            ...
            fig_hist = px.histogram(
                ...
                x='score',
                color='status', 
                title="Histograma de distribucion de puntuacion por Status", #puntuacion
        ...
        with col2:
            ...
            if len(df_filtrado) > 0:
                ...
                fig_bar = px.bar(
                    ...
                    title="Bar Chart Top 10 Mangas Mejor Puntuados", #puntuacion
        ...
        with col1:
            ...
            if len(df_filtrado['demografia'].dropna()) > 0:
                ...
                fig_pie = px.pie(
                    ...
                    title="Pie Chart de distribucion por Demografia",
                    # usar paleta de colores cerezo
                    color_discrete_sequence=SAKURA_DISCRETE_PALETTE
                )
        ...
        with col2:
            ...
            if len(status_counts) > 0:
                fig_pie_status = px.pie(
                    ...
                    values='count',
                    names='status',
                    title="Pie Chart de distribucion por status",
                    # usar paleta de colores cerezo
                    color_discrete_sequence=SAKURA_DISCRETE_PALETTE
                )
