    ...
    if st.session_state.show_charts:
        ...
        with col1:
            ...
            fig_scatter = px.scatter(
                ...
                title="Scatter Plot Puntuacion vs Cantidad de Miembros individual",
            ...
            fig_hist = px.histogram(
                ...
                x='rating_edad',
                color='tipo', #color
                title="Histograma de clasificacion de edad por Tipo de anime",
        ...
        with col2:
            ...
            if len(df_filtrado) > 0:
                ...
                fig_bar = px.bar(
                    ...
                    title="Bar Chart Top 10 Animes Mejor Puntuados y cantidad de favoritos",
        ...
        with col1:
            ...
            fig_pie = px.pie(
                ...
                title="Pie chart distribucion por Fuente de origen del anime",
                # usar paleta de colores cerezo
                color_discrete_sequence=SAKURA_DISCRETE_PALETTE
            )
        ...
        with col2:
            ...
            if not df_sunburst.empty:
                fig_sunburst = px.sunburst(
                    ...
                    values='count',
                    title="Sunburst Chart de distribución Jerarquica",
                    color='count',
                    # usar paleta de colores cerezo
                    color_continuous_scale=SAKURA_CONTINUOUS_PALETTE
                )
